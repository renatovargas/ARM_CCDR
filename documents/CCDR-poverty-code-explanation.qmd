...
author: "Code by Juan Manuel Monroy and Ercio Muñoz, interpreted by Renato Vargas"
...
preserve
	...
	povertyline(pline215 pline365 pline685 lbpl ubpl) gini(Ysim_baseyear) mean(Ysim_baseyear) by(country) 
	g year=$surveyyear
...
preserve
	sp_groupfunction [aw=wgt], poverty(Ysim_baseyear) ///
	povertyline(pline215 pline365 pline685 lbpl ubpl) mean(Ysim_baseyear) by(country region) 
	g year=$surveyyear
...
preserve
	sp_groupfunction [aw=wgt], poverty(Ysim_baseyear) ///
	povertyline(pline215 pline365 pline685 lbpl ubpl) mean(Ysim_baseyear) by(country zone) 
	g year=$surveyyear
...
preserve
	sp_groupfunction [aw=wgt], poverty(Ysim_baseyear) ///
	povertyline(pline215 pline365 pline685 lbpl ubpl) mean(Ysim_baseyear) by(country gender) 
	g year=$surveyyear
